...
<p>
    1. <ExtLink href="https://github.com/alkatrazstudio/neodim-server">Neodim Server</ExtLink>
...
<p>
    ...
    Most of these models are on
    <ExtLink href="https://huggingface.co/models?library=pytorch&amp;pipeline_tag=text-generation&amp;sort=downloads">Hugging Face</ExtLink>.
    The project also includes a simple HTML page to test the server.
</p>
<p>
    Inspired by various "AI Dungeon"-like projects.
</p>
<p>
    2. <ExtLink href="https://github.com/alkatrazstudio/neodim-chat">Neodim Chat</ExtLink>
